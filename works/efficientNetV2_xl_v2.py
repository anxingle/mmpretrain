...
train_pipeline = [
    ...
    dict(
        type='ColorJitter',
        brightness=0.09, # 亮度扰动范围 80%~120% 之间随机调整
        contrast=0.08, # 对比度
        saturation=0.099, # 饱和度
...
custom_hooks = [
    ...
    dict(
        ...
        draw_gt=True,
        draw_pred=True,
        out_dir='./tmp/512_color_v2',  # 图像保存目录
...
param_scheduler = dict(
    type='MultiStepLR', by_epoch=True, milestones=[60, 100, 160, 200], gamma=0.1)
